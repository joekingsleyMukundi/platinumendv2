    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skills', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=225), size=None)),
                ('attachments', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=225), size=None)),
